...
El problema o cuestión central del proyecto fundamentalmente es el almacenamiento de datos. Esto hace referencia a la captura de la información proveniente de la cámara hacia la FPGA, lo cual se logró por medio de la creación de una máquina de estados finitos y su subsecuente almacenado en la memoria de la tarjeta programable. La FSM fue la columna vertical del proyecto, ya que era la que decidía en que momento se tomaba la información, en dónde y cuándo se guardaba la información referente al pixel, en que momento se sobreescribía la información en la memoria para mostrar un nuevo frame o cuando no, para mostrar una fotografía a partir de las señales que transmitía la cámara. Por ende, un fuerte entendimiento de sistemas síncronos y de señales fue lo que permitió el correcto funcionamiento entre la cámara y la tarjeta.
